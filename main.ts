...
class State {
  ...
  constructor() {
    ...
    for (let i = 0; i <= 1; i++) {
      for (let j = 0; j <= 1; j++) {
        this.board[State.height / 2 - i][State.width / 2 - j].set(
          (i + j) % 2 == 0 ? Cell.black : Cell.white
        );
      }
    }
  }
...
class BoardCell {
  ...
  constructor(parent, y: number, x: number) {
    ...
    this.backgroundElem.style.top = `${(BoardCell.cellHeight +
      BoardCell.cellBorder) *
      y +
      BoardCell.cellBorder}px`;
    this.backgroundElem.style.left = `${(BoardCell.cellWidth +
      BoardCell.cellBorder) *
      x +
      BoardCell.cellBorder}px`;
    ...
    this.elem.style.top = `${BoardCell.cellHeight / 2 -
      BoardCell.cellBorder -
      BoardCell.cellRadius}px`;
    this.elem.style.left = `${BoardCell.cellWidth / 2 -
      BoardCell.cellBorder -
      BoardCell.cellRadius}px`;
  ...
  changeBorderColor(color: string) {
    this.backgroundElem.style.border =
      `${BoardCell.cellBorder}px solid ` + color;
  }
}
...
class Board {
  ...
  constructor() {
    ...
    this.parent.style.height = `${(BoardCell.cellHeight +
      BoardCell.cellBorder) *
      State.height +
      BoardCell.cellBorder}px`;
    this.parent.style.width = `${(BoardCell.cellWidth + BoardCell.cellBorder) *
      State.width +
      BoardCell.cellBorder}px`;
